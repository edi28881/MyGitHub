...
?>
	...
	_editor_url  = "<?php echo $base; ?>xinha/";  // (preferably absolute) URL (including trailing slash) where Xinha is installed
	_editor_lang = "en";      // And the language we need to use in the editor.
	</script>
	<script type="text/javascript" src="<?php echo $base; ?>xinha/htmlarea.js"></script>
	<link rel="StyleSheet" href="<?php echo $base; ?>xinha/skins/xp-green/skin.css" type="text/css">
	<script type="text/javascript" >
		xinha_editors = null;
	    xinha_init    = null;
	    xinha_config  = null;
	    xinha_plugins = null;
	    // This contains the names of textareas we will make into Xinha editors   ediiiiiiiiiiiiiiii
