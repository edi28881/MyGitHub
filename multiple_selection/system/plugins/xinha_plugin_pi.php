...
?>
	...
	<link rel="StyleSheet" href="<?=$base?>xinha/skins/xp-blue/skin.css" type="text/css">
	<script type="text/javascript" >
		xinha_editors = null;
	    xinha_init    = null;
	    xinha_config  = null;
	    ...
	    xinha_init = xinha_init ? xinha_init : function()
	    {
		 ...
		 if(!HTMLArea.loadPlugins(xinha_plugins, xinha_init)) return;
	      ...
	      [
	    	...
	    	xinha_config.pageStyle = 'body { font-family: verdana,arial,sans-serif; font-size: .7em; }';
