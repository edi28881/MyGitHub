...
?>
 ...
 -->
 <script type="text/javascript" src="<?php echo base_url();?>xinha/htmlarea.js"></script>
 ...
 <link rel="stylesheet" href="<?php echo base_url();?>xinha/skins/<?php echo $skin;?>/skin.css" type="text/css">
 <?php
 }
 ?>
 <script type="text/javascript">
