...
function chain_select2()
    ...
    $("#tenor_simulasi").change(function(){
				...
				*/
				...
				var pjm = b*(1+bg/100);
				var content = "<table width='700px' class='grid'><tr><th width='10px'></th><th align='center' colspan='5'> <b> Tabel Simulasi Angsuran </b></th></tr><tr align='center'><th width='10px'>No</th><th>Tanggal</th><th>Angsuran Pokok</th><th>Angsuran Bunga</th><th>Total Angsuran</th><th>Sisa</th></tr>"
					     if(a>0){
						 var date = new Date();
						 var d = date.getDate();
						 var m = date.getMonth();
...
<a class='button buttonwhite smallbtn' href='javascript:void(0)' <?php if($this->auth->cek('input_data',true)):?> onclick='tambah() <?php endif;?> '>Tambah Usulan</a>
...
<div class='footer'>
	<a name='simpan_pinjaman' class='button buttonblue smallbtn' href='javascript:void(0)' onclick='simpan_simulasi()'>[S] Simpan</a>
</div>
<?php
